...
public enum InternalMessages {
    ...
    INVALID_WORLD("{0} §4WARNING! §cThe world {1} was not found, using {2}. File: {3} | Path: {4}",
        "{0} §4AVISO! §cO mundo {1} nao foi encontrado, usando {2}. Arquivo: {3} | Caminho: {4}"),
    INVALID_LOCATION("{0} §4WARNING! §cA location was not found. File: {1} | Path: {2}",
        "{0} §4AVISO! §cUm local nao foi encontrado. Arquivo: {1} | Caminho: {2}"),
    INVALID_TELEPORT("{0} §4WARNING! §cThe location of {1}'s teleportation to {2} was not found. Maybe you unloaded the world?",
        "{0} §4AVISO! §cO local do teleporte de {1} para {2} nao foi encontrado. Talvez voce descarregou o mundo?"),
