...
public class ConfigUpdater {
    ...
    public static void update(Plugin plugin, String resourceName, File toUpdate) throws IOException {
        ...
        try {
            Yaml yaml = new Yaml();
            Map<String, String> comments = parseComments(newLines, temp, oldConfig, yaml);
            write(newConfig, oldConfig, comments, temp, writer, yaml);
        } catch (Exception e) {
            e.printStackTrace();
            writer.close();
        } finally {
...
/*
    private static void appendValue(StringBuilder builder, Object value, StringBuilder prefixSpaces, Yaml yaml) {
